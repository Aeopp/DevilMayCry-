...
HRESULT CoreSystem::ReadyEngine(const bool bWindowed)
{
	...
	io.Fonts->AddFontFromFileTTF("..\\..\\Resource\\Font\\BMJUA_ttf.ttf", 12);
	io.Fonts->AddFontFromFileTTF("..\\..\\Resource\\Font\\BMJUA_ttf.ttf", 10);
	io.Fonts->AddFontFromFileTTF("..\\..\\Resource\\Font\\BMJUA_ttf.ttf", 14);
	io.Fonts->AddFontFromFileTTF("..\\..\\Resource\\Font\\BMJUA_ttf.ttf", 18);
